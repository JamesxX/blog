...
It didn't talk about what makes for an intuitive API within the typst ecosystem (see Tingerrr's guidelines on the typst-community GitHub organisation [https://github.com/typst-community/guidelines]).
